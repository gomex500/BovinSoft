...
const initialCareHistory: CareEvent[] = [
  { id: '1', date: '2024-11-15', type: 'Vacunación', description: 'Vacunación anual contra la gripe', performedBy: 'Dr. Smith' },
  { id: '2', date: '2024-11-10', type: 'Revisión', description: 'Reconocimiento médico rutinario', performedBy: 'Dr. Johnson' },
  { id: '3', date: '2024-11-05', type: 'Desparasitación', description: 'Tratamiento antiparasitario trimestral', performedBy: 'Technician Brown' },
  { id: '4', date: '2024-10-28', type: 'Recorte de pezuñas', description: 'Mantenimiento regular de los cascos', performedBy: 'Technician Davis' },
  { id: '5', date: '2024-10-20', type: 'Evaluación nutricional', description: 'Evaluación y ajuste de la dieta', performedBy: 'Nutritionist Wilson' },
];
...
export default function CareHistoryCRUD() {
  ...
  const handleFilter = (filterType: string) => {
    if (filterType === 'Todos') {
      ...
      setFilteredHistory(careHistory.filter(event => event.type === filterType));
    }
  };

  const handleAddEvent = (newEvent: CareEvent) => {
    const updatedHistory = [...careHistory, { ...newEvent, id: Date.now().toString() }];
